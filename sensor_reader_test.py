...
try:
    while True:
        ...
        # طباعة البيانات
        print(f"{pod['rx']},{pod['ry']},{pod['rz']},{pod['ar']},{pod['ap']},{pod['ay']},{pod['z']},"
